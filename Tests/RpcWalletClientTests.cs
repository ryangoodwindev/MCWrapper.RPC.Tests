...
namespace MCWrapper.RPC.Tests
{
    ...
    public class RpcWalletClientTests
    {
        ...
        {
            // *** Inferred blockchain name testing begins

            // Stage
            var infAsset = await _wallet.IssueAsync(Address, new AssetEntity(), 100, 1, 0, null);

            // Act
            var infLocked = await _wallet.PrepareLockUnspentFromAsync(Address,
                new Dictionary<string, decimal> { { "", 0 }, { infAsset.Result, 10 } }, true);
            ...
            // Act
            var infRawExch = await _wallet.CreateRawExchangeAsync(infLocked.Result.Txid, infLocked.Result.Vout,
            ...
            // *** Explicit blockchain name testing begins
            ...
            // Act
            var expLocked = await _wallet.PrepareLockUnspentFromAsync(ChainName, UUID.NoHyphens, Address,
                new Dictionary<string, decimal> { { expAsset.Result, 10 } }, true);
