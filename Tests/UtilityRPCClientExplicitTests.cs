...
namespace MCWrapper.RPC.Tests
{
    ...
    public class UtilityRPCClientExplicitTests
    {
        ...
        public async Task BinaryCacheTestAsync()
        {
            ...
            var cache = await Utility.CreateBinaryCacheAsync(blockchainName: Utility.BlockchainOptions.ChainName, id: nameof(BinaryCacheTestAsync));
            ...
            var append = await Utility.AppendBinaryCacheAsync(
                blockchainName: Utility.BlockchainOptions.ChainName,
            ...
            var delete = await Utility.DeleteBinaryCacheAsync(
                blockchainName: Utility.BlockchainOptions.ChainName,
                id: nameof(BinaryCacheTestAsync),
                identifier: cache.Result);
        ...
        public async Task CreateKeyPairsTestAsync()
        {
            ...
            RpcResponse<CreateKeyPairsResult[]> actual = await Utility.CreateKeyPairsAsync(
                blockchainName: Utility.BlockchainOptions.ChainName,
        ...
        public async Task EstimateFeeTestAsync()
        {
            ...
            var actual = await Utility.EstimateFeeAsync(
                blockchainName: Utility.BlockchainOptions.ChainName,
        ...
        public async Task EstimatePriorityTestAsync()
        {
            ...
            var actual = await Utility.EstimatePriorityAsync(
                blockchainName: Utility.BlockchainOptions.ChainName,
        ...
        public async Task ValidateAddressTestAsync()
        {
            ...
            RpcResponse<ValidateAddressResult> actual = await Utility.ValidateAddressAsync(
                blockchainName: Utility.BlockchainOptions.ChainName,
                id: nameof(ValidateAddressTestAsync),
                address_or_pubkey_or_privkey: Utility.BlockchainOptions.ChainAdminAddress);
        ...
        public async Task VerifyMessageTestAsync()
        {
            ...
            var signature = await Wallet.SignMessageAsync(
                ...
                address_or_privkey: Wallet.BlockchainOptions.ChainAdminAddress,
            ...
            var actual = await Utility.VerifyMessageAsync(
                blockchainName: Wallet.BlockchainOptions.ChainName,
                id: nameof(VerifyMessageTestAsync),
                address: Wallet.BlockchainOptions.ChainAdminAddress,
